...
$("#income-form").on("submit", function (event) {
  ...
  $.post("/api/incm_exp", newIncome)
    .then(function (data) {
      ...
      var th1 = $('<th></th>').addClass('bar').text("incomeSource");
      var th2 = $('<th></th>').addClass('bar').text("incomeCategory");
      var th3 = $('<th></th>').addClass('bar').text("incomeAmount");
      var th4 = $('<th></th>').addClass('bar').text("incomeDescription");
      ...
      var row1 = $('<tr></tr>');
      var td1 = $('<td></td>').addClass('bar').text(newIncome.Source);
      var td2 = $('<td></td>').addClass('bar').text(newIncome.Category);
      var td3 = $('<td></td>').addClass('bar').text(newIncome.Amount);
      var td4 = $('<td></td>').addClass('bar').text(newIncome.Description);
      var td5 = $('<td></td>').addClass('bar').text(newIncome.IEType);
  ...
  $.get("/api/incm_exp", function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      $("#incm-well" + i).append("<h6>Amount: " + data[i].amount + "</h6>");
      $("#incm-well" + i).append("<h6>Category: " + data[i].category + "</h6>");
      $("#incm-well" + i).append("<h6>Description: " + data[i].descript + "</h6>");
      $("#incm-well" + i).append("<h6>Source: " + data[i].source + "</h6>");
      $("#incm-well" + i).append("<h6>Source: " + data[i].IEType + "</h6>");
    }
  });
